...
$busqueda = mysqli_real_escape_string($conexion,
$_POST['busqueda']);,→
...
<html lang="es">
<head>
<meta charset="UTF-8"><title>Buscar Usuarios</title>
</head>
<body>
<h1>Buscar Usuarios</h1>
<form method="POST" action="buscar_usuario.php">
<label>Buscar:</label>
<input type="text" name="busqueda" placeholder="Ingrese un
nombre" required>,→
